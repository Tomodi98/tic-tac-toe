//module to display the Xs and Os in the window
const gameBoard = (() => {
    let fieldsInGrid = [];
    for (let i = 0; i < 9; i++) {
        fieldsInGrid[i] = '';
...
//module to control whose turn it is, win conditions etc.
const gameFlow = (() => {
...
//factory function to create and keep track of players
